...
import com.custom.capture.spinnycamera.Preview.Preview;
import com.custom.capture.spinnycamera.UI.PopupView;
...
public abstract class BaseSpinnyCameraActivity extends Activity {
    ...
    protected TextView mTxvCurrentPhotoLabel;
    protected ImageView mImageView;
    protected View mContainerPhotoTemplateList;
    protected ImageButton mImbPhotoListVisibilityToggle;
     ...
     * @param data
     */
    protected abstract void onPhotoTaken(byte[] data);
    ...
    private void setTakePhotoIcon() {
        ...
        if (preview != null) {
            ...
            viewCamera.setImageResource(R.drawable.switch_camera);
    ...
    public void clickedTakePhoto(View view) {
        ...
        // Checks phone mode(landscape or portrait)
        this.takePicture();
    }
